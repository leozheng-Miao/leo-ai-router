...
ALTER TABLE model
    ADD COLUMN  accessTier VARCHAR(32) DEFAULT 'free' NOT NULL COMMENT '访问等级：free/pro/advanced/image/video' AFTER modelType,
    ADD COLUMN  pointCost INT DEFAULT 0 NOT NULL COMMENT '积分成本：图片/视频单次消耗积分' AFTER outputPrice;
