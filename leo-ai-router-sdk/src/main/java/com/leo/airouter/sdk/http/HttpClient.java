package com.leo.airouter.sdk.http;
...
import com.leo.airouter.sdk.exception.AuthException;
import com.leo.airouter.sdk.exception.LeoAIException;
import com.leo.airouter.sdk.exception.RateLimitException;
import com.leo.airouter.sdk.model.ChatChunk;
import com.leo.airouter.sdk.model.ChatRequest;
import com.leo.airouter.sdk.model.ChatResponse;
import com.leo.airouter.sdk.model.StreamResponse;
...
public class HttpClient {
            ...
            try (Response response = okHttpClient.newCall(httpRequest).execute()) {
                ...
                if (retryCount <= config.getMaxRetries()) {
                    ...
                    try {
                        ...
                        throw new LeoAIException("Request interrupted", ie);
                    }
                }
            }
        }

        throw new LeoAIException("Request failed after " + config.getMaxRetries() + " retries", lastException);
    }
    ...
    public void chatStream(ChatRequest request, StreamCallback callback) {
        ...
        try {
            ...
            if (body == null) {
                throw new LeoAIException("Response body is null");
            }
    ...
    private void handleErrorResponse(Response response) throws IOException {
        ...
        switch (code) {
            ...
            default:
                throw new LeoAIException(code, message);
        }
    }
