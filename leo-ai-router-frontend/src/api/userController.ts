...
/** 此处后端没有提供注释 POST /user/email/register */
export async function userRegisterByEmail(
  body: API.UserEmailRegisterRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLong>('/user/email/register', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /user/email/reset-password */
export async function resetPassword(
  body: API.ResetPasswordRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean>('/user/email/reset-password', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /user/email/send-code */
export async function sendEmailCode(
  body: API.SendEmailCodeRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean>('/user/email/send-code', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
